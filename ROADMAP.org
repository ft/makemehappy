...
forward code.
** TODO Remove Interface Definition
This is not really being used. If the need should really arise, it can be set
for variable definitions inside of module.yaml files. As it stands, this just
clutters things up.
